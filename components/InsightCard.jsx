...
const InsightCard = ({ imgUrl, title, subtitle, index }) => (
    <motion.div variants={fadeIn('up', 'spring', index * 0.4, 1)} className='flex md:flex-row flex-col gap-4'>
        ...
        <div className='w-full flex justify-between items-center'>
            <div className='flex-1 md:ml-[62px] flex flex-col max-w-[650px]'>
                ...
                <p className='mt-[16px] font-normal lg:text0[20px] text-[14px] text-secondary-white'>{subtitle}</p>
            </div>
